...
while (true) {
    ...
    YOUR NUMBER IS "${userInput.guessingNum}" AND COMPUTER NUMBER IS "${compNum}"\n`));
    ...
    else if (allcodes.codes === "CLI CALCULATOR:") {
        console.log(chalk.yellow(`\t\t=============================================\n\t\t   WELLCOME TO THE CLI-CALCULATOR PROGRAM:\n\t\t==============================================`));
        ...
        if (pass.raheem === "raheem") {
            ...
            while (continueCalc) {
                ...
                if (!continueCalc) {
                    console.log(chalk.blue(`\n\t\tTHANKS FOR USING THIS CALCULATOR CREATOR BY "RAHEEM VEER":\n`));
                }
            }
        }
        else {
    ...
    ===================================`));
        ...
        while (continueBmi) {
            ...
            if (!continueBmi) {
                console.log(chalk.yellow(`\n\t\tTHANKS FOR USING CREATOR BY: "RAHEEM VEER"\n`));
            }
        }
    }
